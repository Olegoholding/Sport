...
namespace Sport
{
    public partial class DataPage : Page
    {
        ...
        readonly string connStr = "Server = 95.183.12.18; Port = 3306; Database = sport; user = oleg";
        public DataPage(string pageName, string tag, string uid, string command)
        {
            ...
            NameTextBlock.Text = pageName;
            DataGrid.ItemsSource = LoadData(command).DefaultView;
        }
        private void BackBorder_MouseDown(object sender, MouseButtonEventArgs e) => ((MainWindow)Application.Current.MainWindow).Frame.Content = null;
